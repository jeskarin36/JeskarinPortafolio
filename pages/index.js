...
const Home = () => {
  return <div className="bg-[#3f0c17] h-full">
    <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 top-black/10">
      ...
      <motion.p variants={fadeIn('down',0.3)} initial='hidden' animate='show' exit='hidden' className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16">Amo Programar Y Resolver Problema</motion.p>
