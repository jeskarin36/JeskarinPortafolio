...
const Work = () => {
       return <div className="w-full h-full ">
              ...
              <div className="w-[80%] h-[70%] flex flex-wrap justify-center gap-5  pt-20 ml-14 lg:ml-24 mt-5        bg-[#570317]/50">
                     <Swiper 
                            slidesPerView={3}
                            breakpoints={{
                                   0: {
                     ...
                     >
                            <SwiperSlide>    <div className="w-[19rem] h-[19rem] cursor-pointer m-auto  bg-black">
